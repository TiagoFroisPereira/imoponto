...
export function ProfessionalLegalModal({
  open,
  onAccept,
  onDecline,
}: ProfessionalLegalModalProps) {
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <DialogTitle className="text-xl">Termos de Prestação de Serviços Profissionais</DialogTitle>
          </div>
          <DialogDescription>
            Ao selecionar a categoria profissional e prosseguir com o registo na plataforma Imoponto, 
            declara compreender e aceitar os seguintes termos:
          </DialogDescription>
        </DialogHeader>
